	...
	<section class='bg-light page-section' id='portfolio'>
		<div class='container'>
			<div class='row'>
                ...
                <h2 class='section-heading text-uppercase'>Promoções</h2>
                <h3 class='section-subheading text-muted'>As melhores ofertas, pensadas com carinho!</h3>
                </div>
			</div>
			<div class='row'>";

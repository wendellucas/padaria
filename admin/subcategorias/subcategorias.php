        ...
        <div class='table-wrapper'>
            <div class='table-title'>
                <div class='row'>
                    ...
                    <div class='col-sm-4'>
                        <a href='#addItemModal' class='btn btn-success' data-toggle='modal'>Nova Subcategoria</a>
                    ...
                    <form id='insert 'method='POST' action='insert.php' enctype='multipart/form-data'>
                        ...
                        <div class='modal-body'>
                            <div class='form-group'>
                                ...
                                <input type='text' name='desc' id='desc' class='form-control'><label>Categoria</label>";
                                echo categoriaDLL('null');
                                echo "
                                <label>Imagem</label>

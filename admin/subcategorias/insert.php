...
include '../../conecta/conecta.php';
    ...
    if ($_FILES["fileToUpload"]['size'] <= 0) {
        ...
        if (empty($name)) {
            ...
            $SQL = 	"INSERT INTO `subcategorias`(`nome`, `descricao`, `categoria`) VALUES ('$name', '$desc', '$categ')";
        ...
        && $imageFileType != "gif") {
            ...
            // if everything is ok, try to upload file
                ...
                if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $newFile)) {
                    ...
                    //query string inserting categoria
                    $SQL = 	"INSERT INTO `subcategorias`(`nome`, `descricao`, `img`, `categoria`) VALUES ('$name', '$desc', '$newFile', '$categ')";

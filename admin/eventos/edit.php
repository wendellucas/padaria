...
include '../../conecta/conecta.php';
    ...
    if ($_FILES["fileToUpload"]['size'] <= 0 ){
        ...
        $SQL = 	"UPDATE eventos SET nome = '$nome', descricao = '$desc', data = '$data' WHERE id = '$id'";
        ...
        if (!$mysqli->error) {
            ...
            echo 'SEM ALTERAÇÃO NA TABELA EVENTOS ';
            $bug = $mysqli->error;
        ...
        && $imageFileType != "gif") {
            ...
            // if everything is ok, try to upload file
                ...
                if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $newFile)) {
                    ...
                    //query string inserting student
                    $SQL = 	"UPDATE eventos SET nome = '$nome', descricao = '$desc', data = '$data', img = '$newFile' WHERE id = '$id'";

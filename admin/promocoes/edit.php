...
include '../../conecta/conecta.php';
    ...
    $situacao = $_POST["ativa"];

    if ($_FILES["fileToUpload"]['size'] <= 0 ){
        //query string inserting student
        $SQL = 	"UPDATE promocoes SET nome = '$nome', descricao = '$desc', datainicial = '$datainicial', datafinal = '$datafinal', active='$situacao' WHERE id = '$id'";
        ...
        && $imageFileType != "gif") {
            ...
            // if everything is ok, try to upload file
                ...
                if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $newFile)) {
                    ...
                    //query string inserting student
                    $SQL = 	"UPDATE promocoes SET nome = '$nome', descricao = '$desc', datainicial = '$datainicial', datafinal = '$datafinal', img = '$newFile', active = '$situacao' WHERE id = '$id'";

...
include '../../conecta/conecta.php';
    ...
    if ($_FILES["fileToUpload"]['size'] <= 0) {
        $SQL = 	"INSERT INTO `itens`(`nome`, `descricao`, `preco`, `categoria`) VALUES (\"" . $name ."\", \"" . $desc . "\", \"" . $preco . "\", \"" . $categ . "\")";
        ...
        && $imageFileType != "gif") {
            ...
            // if everything is ok, try to upload file
                ...
                if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $newFile)) {
                    ...
                    $SQL = 	"INSERT INTO `itens`(`nome`, `descricao`, `preco`, `categoria`, `img`) VALUES ('$name', '$desc', '$preco', '$categ', '$newFile')";

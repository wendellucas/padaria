...
function categoriaDLL($selected)
{
    ...
    // SQL
    $sql = "SELECT * FROM subcategorias ORDER BY nome";
            
    //executa query e guarda resultados
    $result = $mysqli->query($sql);

    $catDLL = "<select name='categoria' id='categoria' class='form-control' required><option value=''>Escolha a subcategoria</option>";
